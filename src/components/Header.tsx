      ...
      {menuOpen && (
        <div className="md:hidden bg-white shadow-md">
          <nav className="flex flex-col items-center py-2">
            <Link to="/" className="py-1 text-gray-700 text-sm">홈</Link>
            <Link to="/recommendations" className="py-1 text-gray-700 text-sm">추천 식단</Link>
            <Link to="/profile" className="py-1 text-gray-700 text-sm">프로필</Link>
          </nav>
        </div>
      )}
    </header>
